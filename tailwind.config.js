  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'brand-gradient-r': 'linear-gradient(to right, #1D4ED8, #2563EB, #38BDF8)',
        'sky-fade': 'radial-gradient(120% 120% at 50% 0%, #F0F9FF 0%, #F8FBFF 55%, #FFFFFF 100%)',
        'hero-mesh': 'radial-gradient(ellipse 100% 80% at 20% -10%, #DBEAFE 0%, transparent 55%), radial-gradient(ellipse 80% 60% at 85% 5%, #BFDBFE 0%, transparent 50%), radial-gradient(ellipse 70% 70% at 50% 100%, #EFF6FF 0%, transparent 55%)',
        'blue-teal': 'linear-gradient(135deg, #1D4ED8 0%, #2563EB 50%, #0EA5E9 100%)',
        'teal-blue': 'linear-gradient(135deg, #0EA5E9 0%, #2563EB 50%, #1D4ED8 100%)',
        'glow-blue': 'radial-gradient(ellipse at center, rgba(59,130,246,0.15) 0%, transparent 70%)',
        'glow-teal': 'radial-gradient(ellipse at center, rgba(56,189,248,0.12) 0%, transparent 70%)',
        ...
        'footer-navy': 'linear-gradient(180deg, #1E3A8A 0%, #0F172A 100%)',
      },
      maxWidth: {
        content: '1200px',
        prose: '68ch',
